...
export const Route = createFileRoute("/onboarding/_layout/step3")({
  ...
  return (
    ...
    >
      <div className="space-y-4">
        <Label className="text-base font-semibold">What do you want to accomplish? (Select all that apply)</Label>
      ...
      <div className="space-y-4">
        <Label className="text-base font-semibold">How would you describe your experience with financial tracking?</Label>
        <RadioGroup
      ...
      <div className="space-y-4">
        <Label className="text-base font-semibold">What level of detail do you prefer in your dashboard?</Label>
