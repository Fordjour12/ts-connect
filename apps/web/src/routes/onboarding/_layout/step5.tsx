...
export const Route = createFileRoute("/onboarding/_layout/step5")({
  component: Step6Component,
});

function Step6Component() {
  const features = [
    { icon: BarChart3, title: "Track Expenses", description: "Log transactions and see where your money goes" },
    { icon: Target, title: "Budgets", description: "Set spending limits and get alerts when you exceed them" },
    { icon: PiggyBank, title: "Goals", description: "Save for emergencies, trips, or big purchases" },
    { icon: TrendingUp, title: "Insights", description: "Understand patterns and improve your financial health" }
  ];

  const nextSteps = [
    { icon: Plus, title: "Add Transactions", description: "Log your daily expenses and income to build a complete picture" },
    { icon: Target, title: "Create Your First Budget", description: "Set spending limits for your top expense categories" },
    { icon: PiggyBank, title: "Set a Savings Goal", description: "Choose something meaningful to work towards" }
  ];
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-4">Welcome to Your Financial Dashboard</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          You're all set! Here's a preview of what you can do next. Your dashboard is personalized
