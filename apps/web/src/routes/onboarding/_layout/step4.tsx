...
export const Route = createFileRoute("/onboarding/_layout/step4")({
...
function Step5Component() {
  ...
  const sampleTransactions = [
    { description: "Morning coffee", amount: "4.50", category: "Food & Drink", type: "expense" },
    { description: "Salary deposit", amount: "3500.00", category: "Income", type: "income" },
    { description: "Grocery shopping", amount: "127.84", category: "Groceries", type: "expense" },
  ];
    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight mb-3">Add Your First Transaction</h1>
          <p className="text-muted-foreground max-w-md mx-auto">
            Let's see your account in action by adding a sample transaction. You can always add more
            later!
          </p>
        </div>

        <div className="space-y-4">
          <Label className="text-sm text-muted-foreground">Quick examples to get you started:</Label>
            ...
            {sampleTransactions.map((sample, index) => (
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <div
                    className={`font-medium ${sample.type === "income" ? "text-success" : "text-foreground"}`}
                  >
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight mb-3">Create Your First Account</h1>
        <p className="text-muted-foreground max-w-md mx-auto">
          Let's set up your primary account so you can start tracking transactions. Don't worry, you
