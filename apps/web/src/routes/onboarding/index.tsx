...
function WelcomeComponent() {
  ...
  return (
    <div className="space-y-12 container mx-auto max-w-4xl">
      <div className="text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Build a personal financial system that helps you track spending, stick to budgets, and
          achieve your money goals—all with complete privacy.
        </p>
      </div>
      ...
      <Card className="border-2 border-primary/10 bg-primary/5">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Get started in under 2 minutes. We'll guide you through a simple setup to personalize
            your experience and show you how to track your first transaction.
          </p>
